...
public class ModBlocks {
    ...
    public static final Block DIRT_SLAB = registerBlock("dirt_slab",
            new SlabBlock(FabricBlockSettings.of(Material.SOIL).strength(0.5f).sounds(BlockSoundGroup.GRASS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block SOUL_SAND_SLAB = registerBlock("soul_sand_slab",
            new SlabBlock(FabricBlockSettings.of(Material.SOIL).strength(0.5f).sounds(BlockSoundGroup.SOUL_SAND)), ItemGroup.BUILDING_BLOCKS);
    public static final Block SOUL_SOIL_SLAB = registerBlock("soul_soil_slab",
            new SlabBlock(FabricBlockSettings.of(Material.SOIL).strength(0.5f).sounds(BlockSoundGroup.SOUL_SOIL)), ItemGroup.BUILDING_BLOCKS);

    //Stairs
    public static final Block DIRT_STAIRS = registerBlock("dirt_stairs",
            new ModStairsBlock(Blocks.DIRT.getDefaultState(), FabricBlockSettings.of(Material.SOIL).strength(0.5f).sounds(BlockSoundGroup.GRASS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block SOUL_SOIL_STAIRS = registerBlock("soul_soil_stairs",
            new ModStairsBlock(Blocks.SOUL_SOIL.getDefaultState(), FabricBlockSettings.of(Material.SOIL).strength(0.5f).sounds(BlockSoundGroup.SOUL_SOIL)), ItemGroup.BUILDING_BLOCKS);

    //TrapDoors
    public static final Block DIRT_TRAPDOOR = registerBlock("dirt_trapdoor",
            new ModTrapDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(0.5f).sounds(BlockSoundGroup.GRASS).nonOpaque()), ItemGroup.BUILDING_BLOCKS);

    //Doors
    public static final Block DIRT_DOOR = registerBlock("dirt_door",
            new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(0.5f).sounds(BlockSoundGroup.GRASS).nonOpaque()), ItemGroup.BUILDING_BLOCKS);
